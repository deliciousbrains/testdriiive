...
function editor_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		...
		<div class="nav-links">
			<?php
				previous_post_link( '<div class="nav-previous">%link</div>', _x( '<span class="meta-nav">Previous Post</span> %title', 'Previous post link', 'editor' ) );
				next_post_link(     '<div class="nav-next">%link</div>',     _x( '<span class="meta-nav">Next Post</span> %title', 'Next post link',     'editor' ) );
			?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
	<?php
...
function editor_categorized_blog() {
	if ( false === ( $all_the_cool_cats = get_transient( 'editor_categories' ) ) ) {
		...
		set_transient( 'editor_categories', $all_the_cool_cats );
	}
